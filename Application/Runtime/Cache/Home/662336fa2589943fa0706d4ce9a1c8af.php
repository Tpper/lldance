...
<div class="wrap mt10 clearfix">
    ...
    <div class="section fr">
        ...
        <div class="pd20 bg-w mt10 bdr">
            ...
            <div class="safe">
                <form action="<?php echo U('safe');?>" method="post">
                <table class="safe-tab">
                    <tr>
                        <th>手机号码：</th>
                        <td><input type="text" name="tel"/> <input type="button" value="获取短信验证码"></td>
                    </tr>
                    <tr>
                        <th>请输入手机验证码</th>
                    ...
                    <tr>
                        <th>身份证：</th>
                        <td><input type="file" name="file"/>上传身份证</td>
                    </tr>
                    <tr>
                        <th>电子邮箱：</th>
                    ...
                    <tr>
                        <th><input type="button" value="提交" /></th>
...
<script>
    $(function(){
        $('tr:eq(0) input:eq(1)').click(function(){
            var telphone=$('tr:eq(0) input:eq(0)').val();
            $.get('/index.php/Home/Member/send/tel/'+telphone,function(e){alert('短信已发送')},'json')
        });
        $('input[value=提交]').click(function(){
            var sms=$('input[name=sms]').val();
            $.post('/index.php/Home/Member/checkSafe/sms/'+sms,function(e){
                if(e[0]==0){
                    alert('短信验证码不正确');
                }else{
                    $('form').submit();
        ...
        <div class="bd" id="form1">
            ...
            <div class="form">
                ...
                <button type="button" value="" class="button login" id="login"
                        onclick="window.location.href='member.html'">登录
                </button>
