...
<div class="wrap mt10 clearfix">
  ...
  <div class="section fr">
    <div class="pd20 bg-w bdr">
      <div class="mem-hd clearfix"><span class="fr"><em class="ico mail-ico"></em>
        <b class="c">2</b> 封未读信息</span>您好！
        <b><?php echo ($_SESSION['name']['pname']); ?></b>
          <!--<em class="ico Cup"></em>可用积分<b class="c">100</b>分-->
      </div>
      <div class="mt20 clearfix">
        <div class="user-info fl">
          ...
          <div class="txt fl">
            账户余额
            <h1 class="Balance"><?php echo ($money["money"]); ?></h1>
            <!--投资总额 0.00 元    贷款总额 0.00 元-->
          </div>
          <div class="btnbox fl">
