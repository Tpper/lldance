...
$(function() {
    ...
    var menu = [{
            ...
            "childMenus": [{
                    ...
                    "isHeader": "0",
                    "childMenus": [
                        { "id": "20", "name": "用户列表", "parentId": "3", "url": "/index.php/Admin/User/user", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" },
                    ]
                },
                {
                    "id": "3",
                    ...
                    "isHeader": "0",
                    "childMenus": [
                        { "id": "4", "name": "投资项目管理", "parentId": "3", "url": "/index.php/Admin/Invest/investList", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" },
                        { "id": "5", "name": "用户投资状态", "parentId": "3", "url": "/index.php/Admin/Invest/investStatus", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" }
                    ]
                },
                {
                    "id": "6",
                    ...
                    "isHeader": "0",
                    "childMenus": [
                        { "id": "7", "name": "借款列表", "parentId": "6", "url": "/index.php/Admin/Borrow/index", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" },
                        { "id": "8", "name": "借款统计", "parentId": "6", "url": "/index.php/Admin/Borrow/tongji", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" }
                    ]
                },
                {
                    "id": "21",
                    ...
                    "isHeader": "0",
                    "childMenus": [
                        { "id": "22", "name": "网站公告", "parentId": "3", "url": "test1.html", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" },
                        { "id": "23", "name": "媒体报道", "parentId": "3", "url": "test2.html", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" }
                    ]
                },
            ...
            "childMenus": [,
                {
                    ...
                    "childMenus": [{
                            ...
                            "isHeader": "0",
                            "childMenus": [
                                { "id": "26", "name": "发信", "parentId": "12", "url": "/index.php/Admin/Email/add", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" },
                                { "id": "10", "name": "发件箱", "parentId": "12", "url": "/index.php/Admin/Email/send", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" },
                                {
                                    "id": "27",
                                    "name": "收件箱",
                                    "parentId": "12",
                                    "url": "/index.php/Admin/Email/receive",
                                    "icon": "",
                                    "order": "1",
                                    "isHeader": "0",
                                    "childMenus": [
                        ...
                        },
                        {
                            ...
                            "isHeader": "0",
                            "childMenus": [
                                { "id": "13", "name": "发信", "parentId": "12", "url": "/index.php/Admin/EmailUser/add_User", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" },
                                { "id": "9", "name": "发件箱", "parentId": "12", "url": "/index.php/Admin/EmailUser/send_User", "icon": "", "order": "1", "isHeader": "0", "childMenus": "" }
